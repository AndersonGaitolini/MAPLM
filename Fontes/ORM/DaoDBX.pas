...
uses Base, Rtti, Atributos, system.SysUtils, system.Classes,
  ibx.IB, ibx.IBQuery, ibx.IBDatabase, system.Generics.Collections,
  Data.DB, Data.SqlTimSt, Data.FmtBcd, Data.DBCommonTypes,Data.SqlExpr;
...
type
  ...
  private
    FConexao: TSQLConnection; //TDBDatabase;
